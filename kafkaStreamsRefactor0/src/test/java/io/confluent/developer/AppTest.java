...
public class AppTest {
  ...
  public AppTest() throws IOException {
    allProps = App.loadEnvProperties(TEST_CONFIG_FILE);
    allProps.put(StreamsConfig.STATE_DIR_CONFIG, STATE_DIR.toString());
  }

  private static SpecificAvroSerde<shoe_customers> makeSerializer(Properties allProps) {
    SpecificAvroSerde<shoe_customers> serde = new SpecificAvroSerde<>();
  ...
  public void shouldFilterDistinctEvents() {
    ...
    final App distinctifier = new App();
